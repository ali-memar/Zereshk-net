...
(function (c, k, l) {
    function f() {
        return parseInt(e.scrollTop() + e.height()) === parseInt(m.height()) ? !0 : !1
    }

    function g(a) {
        return null === a ? 0 : "string" === typeof a && 0 < c(a).length ? c(a).outerHeight() : console.log("Section Scroller Error: Wrong fixedNavbar option provided!")
    }
    ...
    d.prototype = {
        constructor: d, init: function () {
            ...
            for (var b = 0, d = a.offset + g(a.fixedNavbar); b < a.elements.length && Math.round(e.scrollTop()) >= Math.round(c(a.elements[b]).offset().top - d);) b++;
            if (b >= a.elements.length || f()) b = 0;
            a.scrollToElementIndex = b;
            a.options.onScrollStart.call(a);
            c("html, body").stop().animate({
                scrollTop: Math.round(c(a.elements[b]).offset().top -
                    d) + Math.round(Number(c(a.elements[b]).data("scroll-offset")) ? Number(c(a.elements[b]).data("scroll-offset")) : 0)
            }, a.scrollDuration, a.scrollType).promise().done(function () {
                a.options.onScrollEnd.call(a)
            })
        }, scrollerButtonRotateClassHandler: function (a) {
            var b = a.offset + g(a.fixedNavbar);
            f() ? (b = a.scrollerButton, a = a.scrollerButtonRotateClass, b.hasClass(a) || b.addClass(a)) : Math.round(e.scrollTop()) >= Math.round(c(a.elements[a.elements.length - 1]).offset().top - b) ? (b = a.scrollerButton, a = a.scrollerButtonRotateClass,
            b.hasClass(a) || b.addClass(a)) : (b = a.scrollerButton, a = a.scrollerButtonRotateClass, b.hasClass(a) && b.removeClass(a))
        }
    };
    c.fn.sectionScroller = function (a) {
        c.data(this, "plugin_sectionScroller") || c.data(this, "plugin_sectionScroller", new d(this, a));
        return this
    }
